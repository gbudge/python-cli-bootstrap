...
All notable changes to this project will be mycliumented in this file.
...
- Updated README mycliumentation to describe configurable prefixing and the new `[tool.yourcli]` keys.
...
- Project mycliumentation (README.md)
- MIT License
